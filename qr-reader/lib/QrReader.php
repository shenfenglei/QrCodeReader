...
final class QrReader
{
    ...
    function __construct($imgsource, $getLoacation=false,$sourcetype = QrReader::SOURCE_TYPE_FILE, $isUseImagickIfAvailable = true)
    {
        try {
            switch ($sourcetype) {
            ...
            if($getLoacation){
                $this->result = $reader->getLocation($bitmap);
            }
            else{
